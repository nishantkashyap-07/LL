      ...
      <div className="container-elegant py-12">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-neutral-500 text-sm">Review and approve seller applications</p>
          </div>
          <div className="text-right">
            <p className="text-2xl font-bold text-neutral-100">{sellers.length}</p>
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-neutral-800">
                  {sellers.map((seller, i) => (
                    <motion.tr key={seller.id} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: i * 0.03 }} className="hover:bg-neutral-800/30 transition-colors">
                      <td className="px-5 py-4">
                        <p className="text-sm font-medium text-neutral-200">{seller.fullName || 'N/A'}</p>
                        <p className="text-xs text-neutral-500">{seller.email || 'N/A'}</p>
                      </td>
                      <td className="px-5 py-4 text-sm text-neutral-400">{seller.phone || 'N/A'}</td>
                      <td className="px-5 py-4">
                      ...
                      <td className="px-5 py-4">
                        <div className="flex items-center justify-end gap-1.5">
                          <button className="p-1.5 bg-neutral-800 hover:bg-neutral-700 rounded-lg transition-colors" title="View Documents">
