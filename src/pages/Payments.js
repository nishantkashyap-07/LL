    ...
    <div className="pt-20 min-h-screen bg-neutral-50 dark:bg-neutral-950">
      ...
      <div className="container-elegant py-12">
        <div className="mb-8">
          ...
          <p className="text-neutral-500 dark:text-neutral-500 text-sm">Track all your payment transactions</p>
        </div>

        {/* Stats */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          {statCards.map((s) => (
            <div key={s.label} className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-xl p-5 flex items-center justify-between">
              <div>
        ...
        {/* Filters */}
        <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-xl p-4 mb-6 flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="space-y-3">
          {filtered.length > 0 ? (
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-center">
                    <div className="lg:col-span-5">
                      <div className="flex items-center gap-2 text-xs text-neutral-500 dark:text-neutral-500 mb-1">
                        <span className="text-neutral-700 dark:text-neutral-300 font-medium">{payment.id}</span>
                        <span>·</span>
                        <span>Booking: {payment.bookingId}</span>
                      </div>
                      <h3 className="text-base font-semibold text-neutral-900 dark:text-neutral-100 mb-1">{payment.vehicleName}</h3>
                    ...
                    <div className="lg:col-span-3">
                      <p className="text-xs text-neutral-500 dark:text-neutral-500 mb-1">Transaction ID</p>
                      <p className="text-xs font-mono text-neutral-700 dark:text-neutral-300 bg-neutral-100 dark:bg-neutral-800 px-2.5 py-1.5 rounded-lg inline-block">{payment.transactionId}</p>
                    </div>
                    <div className="lg:col-span-2">
                      <p className="text-xs text-neutral-500 dark:text-neutral-500 mb-1">Amount</p>
                      <p className="text-xl font-bold text-neutral-900 dark:text-neutral-100">₹{payment.amount}</p>
                    ...
                    <div className="lg:col-span-2">
                      <button
                        ...
                        className="w-full flex items-center justify-center gap-2 bg-neutral-100 dark:bg-neutral-800 hover:bg-neutral-200 dark:hover:bg-neutral-700 border border-neutral-200 dark:border-neutral-700 text-neutral-700 dark:text-neutral-300 px-4 py-2.5 rounded-lg text-xs transition-colors"
                      >
            ...
            <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-16 text-center">
              ...
              <h3 className="text-base font-semibold text-neutral-700 dark:text-neutral-300 mb-2">No payments found</h3>
