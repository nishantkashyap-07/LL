    ...
    <div className="pt-20 min-h-screen bg-neutral-950">
      ...
      <div className="container-elegant py-12">
        <div className="mb-8">
          ...
          <p className="text-neutral-500 text-sm">Manage bookings for your vehicles</p>
        </div>
        ...
        <div className="flex flex-wrap gap-2 mb-8">
          {tabs.map((tab) => {
            ...
            return (
              ...
              >
                {tab.label}
                <span className={`px-1.5 py-0.5 rounded-full text-xs ${activeTab === tab.id ? 'bg-neutral-900/20' : 'bg-neutral-700'}`}>{count}</span>
              </button>
            );
          })}
        </div>
        ...
        {loading ? (
                  ...
                  >
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
                      <div className="lg:col-span-6">
                        ...
                        <h3 className="text-base font-bold text-neutral-100 mb-3">{booking.vehicleName}</h3>
                      ...
                      <div className="lg:col-span-3">
                        ...
                        <p className="text-xl font-bold text-neutral-100 mb-1.5">₹{booking.amount}</p>
                      ...
                      <div className="lg:col-span-3 flex flex-col gap-2">
                        ...
                        <button className="flex items-center justify-center gap-1.5 bg-neutral-800 hover:bg-neutral-700 border border-neutral-700 text-neutral-300 py-2 rounded-lg text-xs transition-colors">
          ...
          <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-16 text-center">
            ...
            <h3 className="text-base font-semibold text-neutral-300 mb-2">No bookings found</h3>
