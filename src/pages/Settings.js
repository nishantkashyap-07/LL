    ...
    <div className="pt-20 min-h-screen bg-neutral-950">
      ...
      <div className="container-elegant py-12">
        <div className="mb-8">
          ...
          <p className="text-neutral-500 text-sm">Manage your account preferences and security</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-3">
              {sidebarItems.map((item) => (
                <button key={item.label} className="w-full flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-neutral-800 transition-colors text-left">
          ...
          <div className="lg:col-span-3 space-y-5">
            ...
            <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-6">
              <h2 className="text-base font-semibold text-neutral-100 mb-5 flex items-center gap-2">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={item.key} className="flex items-center justify-between p-4 bg-neutral-800 rounded-xl">
                    <div>
            ...
            <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-6">
              <h2 className="text-base font-semibold text-neutral-100 mb-5 flex items-center gap-2">
                <Shield size={16} className="text-neutral-400" /> Privacy
              </h2>
              <div className="space-y-3">
                {[
            ...
            <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-6">
              <h2 className="text-base font-semibold text-neutral-100 mb-5 flex items-center gap-2">
                <Lock size={16} className="text-neutral-400" /> Change Password
              </h2>
              <form onSubmit={handlePasswordChange} className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <button type="button" onClick={() => setShowCurrentPw(!showCurrentPw)} className="absolute right-4 top-1/2 -translate-y-1/2 text-neutral-500 hover:text-neutral-300">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <button type="button" onClick={() => setShowNewPw(!showNewPw)} className="absolute right-4 top-1/2 -translate-y-1/2 text-neutral-500 hover:text-neutral-300">
                ...
                <button type="submit" disabled={loading} className="flex items-center gap-2 bg-neutral-800 hover:bg-neutral-700 border border-neutral-700 text-neutral-200 font-medium px-5 py-2.5 rounded-xl text-sm transition-all disabled:opacity-50">
            ...
            <div className="bg-neutral-900 border border-red-900/30 rounded-2xl p-6">
              ...
              <div className="p-4 bg-red-500/5 border border-red-500/20 rounded-xl">
                <p className="text-sm font-medium text-neutral-200 mb-1">Delete Account</p>
                <p className="text-xs text-neutral-500 mb-4">Once you delete your account, there is no going back.</p>
                <button
