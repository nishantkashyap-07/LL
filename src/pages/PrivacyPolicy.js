      ...
      <Container size="md" className="py-12">
        <Stack spacing="xl">
                    ...
                    <div className="space-y-3">
                      {section.content.map((item, idx) => (
                        <div key={idx} className="flex items-start space-x-3">
                          ...
                          <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed">{item}</p>
                        </div>
                      ))}
                    </div>
                  </div>
          ...
          <Card variant="glass" padding="lg" className="bg-secondary-500/5 border-secondary-500/20">
            ...
            <p className="text-neutral-600 dark:text-neutral-400 mb-4">If you have questions about this Privacy Policy:</p>
