    ...
    <div className="pt-20 min-h-screen bg-neutral-50 dark:bg-neutral-950">
      ...
      <div className="container-elegant py-12">
        <div className="mb-8">
          ...
          <p className="text-neutral-500 dark:text-neutral-500 text-sm">Track your revenue and transactions</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          {statCards.map((s, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.1 }}
              className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-xl p-5 flex items-center justify-between">
              <div>
        ...
        <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-6">
          <h2 className="text-base font-semibold text-neutral-900 dark:text-neutral-100 mb-5">Recent Transactions</h2>
            ...
            {transactions.length === 0 ? (
              ...
              transactions.map((txn, i) => (
                <motion.div key={txn.id} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: i * 0.05 }}
                  ...
                  <div>
                    <p className="text-sm font-medium text-neutral-800 dark:text-neutral-200">{txn.vehicle}</p>
                    <p className="text-xs text-neutral-500 dark:text-neutral-500 mt-0.5">Booking: {txn.booking} · {txn.date}</p>
                  </div>
                  <div className="text-right">
                    <p className="text-base font-bold text-neutral-900 dark:text-neutral-100">₹{txn.amount}</p>
