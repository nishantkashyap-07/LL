    ...
    <div className="pt-20 min-h-screen bg-neutral-50 dark:bg-neutral-950">
      ...
      <div className="container-elegant py-12">
        <div className="mb-8">
          ...
          <p className="text-neutral-500 dark:text-neutral-500 text-sm">Manage your personal information and preferences</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-6 flex flex-col items-center text-center">
            <div className="relative mb-4">
              <div className="w-24 h-24 bg-neutral-100 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-full flex items-center justify-center text-3xl font-bold text-neutral-800 dark:text-neutral-200">
                {user?.photoURL
              ...
              <motion.button
                ...
                className="absolute bottom-0 right-0 w-8 h-8 bg-neutral-700 border border-neutral-300 dark:border-neutral-600 rounded-full flex items-center justify-center"
              >
                <Camera size={14} className="text-neutral-700 dark:text-neutral-300" />
              </motion.button>
            </div>

            <h2 className="text-lg font-semibold text-neutral-900 dark:text-neutral-100 mb-0.5">{user?.name || 'User'}</h2>
            <p className="text-sm text-neutral-500 dark:text-neutral-500 mb-3">{user?.email}</p>
            ...
            <div className="w-full border-t border-neutral-200 dark:border-neutral-800 pt-4 space-y-3">
              {[
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                <h3 className="text-base font-semibold text-neutral-800 dark:text-neutral-200 mb-4 flex items-center gap-2">
                  <User size={16} className="text-neutral-600 dark:text-neutral-400" /> Personal Information
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs text-neutral-500 dark:text-neutral-500 mb-1.5">Full Name</label>
                    <input type="text" name="name" value={formData.name} onChange={handleChange} placeholder="Your full name" className={inputClass} />
                  </div>
                  <div>
                    <label className="block text-xs text-neutral-500 dark:text-neutral-500 mb-1.5">Email Address</label>
                    <input type="email" name="email" value={formData.email} disabled className="w-full px-4 py-3 bg-neutral-100 dark:bg-neutral-800/50 border border-neutral-200 dark:border-neutral-800 rounded-xl text-neutral-500 dark:text-neutral-500 cursor-not-allowed text-sm" />
                  </div>
                  <div>
                    <label className="block text-xs text-neutral-500 dark:text-neutral-500 mb-1.5">Phone Number</label>
                    <input type="tel" name="phone" value={formData.phone} onChange={handleChange} placeholder="+91 98765 43210" className={inputClass} />
                  </div>
                  <div>
                    <label className="block text-xs text-neutral-500 dark:text-neutral-500 mb-1.5">Date of Birth</label>
              ...
              <div>
                <h3 className="text-base font-semibold text-neutral-800 dark:text-neutral-200 mb-4 flex items-center gap-2">
                  <MapPin size={16} className="text-neutral-600 dark:text-neutral-400" /> Address Details
                </h3>
                <div className="space-y-4">
                  <div>
                    <label className="block text-xs text-neutral-500 dark:text-neutral-500 mb-1.5">Street Address</label>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      <label className="block text-xs text-neutral-500 dark:text-neutral-500 mb-1.5">City</label>
              ...
              <div>
                <h3 className="text-base font-semibold text-neutral-800 dark:text-neutral-200 mb-4 flex items-center gap-2">
                  <Shield size={16} className="text-neutral-600 dark:text-neutral-400" /> Verification Documents
                </h3>
                <div className="flex items-center justify-between p-4 bg-neutral-100 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-xl">
                  <div>
                    <p className="text-sm font-medium text-neutral-800 dark:text-neutral-200 mb-0.5">Driving License</p>
                    <p className="text-xs text-neutral-500 dark:text-neutral-500">Upload your valid driving license</p>
                  </div>
                  <button type="button" className="flex items-center gap-2 px-4 py-2 bg-neutral-700 hover:bg-neutral-600 border border-neutral-300 dark:border-neutral-600 text-neutral-800 dark:text-neutral-200 rounded-lg text-xs transition-colors">
