  ...
  if (!booking) return (
    <div className="pt-20 min-h-screen bg-neutral-50 dark:bg-neutral-950 flex items-center justify-center">
      <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-12 text-center max-w-sm">
        ...
        <h2 className="text-xl font-bold text-neutral-900 dark:text-neutral-100 mb-2">No booking found</h2>
        <p className="text-neutral-500 dark:text-neutral-500 text-sm mb-6">It looks like you haven't made a booking yet.</p>
    ...
    <div className="pt-20 min-h-screen bg-neutral-50 dark:bg-neutral-950">
      ...
      <div className="container-elegant py-12">
        ...
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="text-center mb-10">
          ...
          <p className="text-neutral-600 dark:text-neutral-400">Your vehicle rental request has been submitted successfully</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-5">
            <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-xs text-neutral-500 dark:text-neutral-500 mb-1.5">Booking ID</p>
                  <div className="px-3 py-2.5 bg-neutral-100 dark:bg-neutral-800 rounded-xl text-sm font-mono text-neutral-800 dark:text-neutral-200">{booking.bookingId || 'Pending'}</div>
                </div>
                <div>
                  <p className="text-xs text-neutral-500 dark:text-neutral-500 mb-1.5">Vehicle</p>
                  <div className="px-3 py-2.5 bg-neutral-100 dark:bg-neutral-800 rounded-xl text-sm font-semibold text-neutral-800 dark:text-neutral-200">{booking.vehicleName}</div>
                </div>
                <div>
                  <p className="text-xs text-neutral-500 dark:text-neutral-500 mb-1.5">Rental Type</p>
                  <div className="px-3 py-2.5 bg-neutral-100 dark:bg-neutral-800 rounded-xl text-sm text-neutral-800 dark:text-neutral-200 capitalize">{booking.rentalType || 'daily'}</div>
                </div>
                <div>
                  <p className="text-xs text-neutral-500 dark:text-neutral-500 mb-1.5">Duration</p>
                  <div className="flex items-center gap-2 px-3 py-2.5 bg-neutral-100 dark:bg-neutral-800 rounded-xl">
                    <Clock className="w-3.5 h-3.5 text-neutral-600 dark:text-neutral-400" />
                    <span className="text-sm text-neutral-800 dark:text-neutral-200">{booking.duration} {booking.rentalType === 'hourly' ? 'hours' : 'days'}</span>
                  </div>
                </div>
                <div>
                  ...
                  <div className="px-3 py-2.5 bg-neutral-100 dark:bg-neutral-800 rounded-xl">
                    <p className="text-sm text-neutral-800 dark:text-neutral-200 flex items-center gap-1.5"><Calendar className="w-3.5 h-3.5 text-neutral-600 dark:text-neutral-400" />{formatDate(booking.pickupDate)}</p>
                ...
                <div>
                  ...
                  <div className="px-3 py-2.5 bg-neutral-100 dark:bg-neutral-800 rounded-xl">
                    <p className="text-sm text-neutral-800 dark:text-neutral-200 flex items-center gap-1.5"><Calendar className="w-3.5 h-3.5 text-neutral-600 dark:text-neutral-400" />{formatDate(booking.returnDate)}</p>
                ...
                <div className="col-span-2">
                  <p className="text-xs text-neutral-500 dark:text-neutral-500 mb-1.5">Total Amount</p>
                  <div className="px-3 py-2.5 bg-neutral-100 dark:bg-neutral-800 rounded-xl text-lg font-bold text-neutral-900 dark:text-neutral-100">{formatCurrency(booking.totalAmount)}</div>
                </div>
              </div>
            </div>
            ...
            {/* Next Steps */}
            <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-6">
              <h3 className="text-base font-semibold text-neutral-900 dark:text-neutral-100 mb-5">What happens next?</h3>
          ...
          <div className="space-y-5">
            <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-5 space-y-2">
              <button className="w-full flex items-center justify-center gap-2 bg-neutral-100 dark:bg-neutral-800 hover:bg-neutral-200 dark:hover:bg-neutral-700 border border-neutral-200 dark:border-neutral-700 text-neutral-700 dark:text-neutral-300 py-2.5 rounded-xl text-sm transition-colors">
