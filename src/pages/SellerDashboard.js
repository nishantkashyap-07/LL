...
const statusCls = {
  ...
  completed: 'bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-400 border-neutral-200 dark:border-neutral-700',
  ...
  if (loading) {
    return (
      <div className="pt-20 min-h-screen bg-neutral-50 dark:bg-neutral-950 flex items-center justify-center">
        <div className="w-10 h-10 border-2 border-neutral-200 dark:border-neutral-700 border-t-neutral-300 rounded-full animate-spin" />
      </div>
    );
  }
    ...
    <div className="pt-20 min-h-screen bg-neutral-50 dark:bg-neutral-950">
      ...
      <div className="container-elegant py-10">
        ...
        <div className="flex items-center justify-between mb-10">
          <div>
            <p className="text-neutral-500 dark:text-neutral-500 text-sm mb-1">Seller Portal</p>
          ...
          {statCards.map((s, i) => (
            <motion.div key={s.label} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.07 }} className="card-minimal">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs text-neutral-500 dark:text-neutral-500 mb-1">{s.label}</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="card-minimal">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-base font-semibold text-neutral-800 dark:text-neutral-200">My Vehicles</h2>
                <Link to="/seller/vehicles" className="text-xs text-neutral-600 dark:text-neutral-400 hover:text-neutral-800 dark:text-neutral-200 flex items-center gap-1 transition-colors">
              ...
              {vehicles.length === 0 ? (
                <div className="text-center py-10">
                  ...
                  <p className="text-neutral-500 dark:text-neutral-500 text-sm mb-4">No vehicles listed yet</p>
                  <Link to="/seller/vehicles/new"
                ...
                <div className="space-y-3">
                  {vehicles.map((v, i) => (
                    <motion.div key={v.id} initial={{ opacity: 0, x: -16 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: i * 0.07 }}
                      className="flex items-center justify-between p-3 bg-neutral-100 dark:bg-neutral-800/40 rounded-xl border border-neutral-200 dark:border-neutral-700/40">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-neutral-800 dark:text-neutral-200">{v.name}</p>
                          <p className="text-xs text-neutral-500 dark:text-neutral-500 capitalize">{v.type} · ₹{v.price || v.pricePerDay}/day</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
                        <StatusBadge status={v.status || 'active'} />
                        <Link to={`/vehicles/${v.id}`} className="p-1.5 hover:bg-neutral-200 dark:hover:bg-neutral-700 rounded-lg transition-colors text-neutral-500 dark:text-neutral-500 hover:text-neutral-700 dark:text-neutral-300">
                          <Eye className="w-3.5 h-3.5" />
                        </Link>
                        <Link to={`/seller/vehicles/edit/${v.id}`} className="p-1.5 hover:bg-neutral-200 dark:hover:bg-neutral-700 rounded-lg transition-colors text-neutral-500 dark:text-neutral-500 hover:text-neutral-700 dark:text-neutral-300">
          ...
          <div>
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.25 }} className="card-minimal">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-base font-semibold text-neutral-800 dark:text-neutral-200">Recent Bookings</h2>
                <Link to="/seller/bookings" className="text-xs text-neutral-600 dark:text-neutral-400 hover:text-neutral-800 dark:text-neutral-200 flex items-center gap-1 transition-colors">
                  View all <ArrowRight className="w-3.5 h-3.5" />
                </Link>
              </div>
              ...
              {recentBookings.length === 0 ? (
                <div className="text-center py-8">
                  <div className="w-10 h-10 bg-neutral-100 dark:bg-neutral-800 rounded-xl flex items-center justify-center mx-auto mb-3">
                ...
                <div className="space-y-3">
                  {recentBookings.map((b, i) => (
                    <motion.div key={b.id} initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.07 }}
                      className="p-3 bg-neutral-100 dark:bg-neutral-800/40 rounded-xl border border-neutral-200 dark:border-neutral-700/40">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-xs text-neutral-500 dark:text-neutral-500 font-mono">#{b.id?.slice(-6) || '------'}</span>
                        <StatusBadge status={b.status} />
                      </div>
                      <p className="text-sm font-medium text-neutral-800 dark:text-neutral-200 mb-1">{b.vehicleName || 'Vehicle'}</p>
                      <p className="text-xs text-neutral-500 dark:text-neutral-500 mb-2">{b.userName || b.customerName || 'Customer'}</p>
                      <div className="flex items-center justify-between text-xs">
                        <span className="text-neutral-500 dark:text-neutral-500">{b.pickupDate}</span>
                        <span className="font-semibold text-neutral-800 dark:text-neutral-200">₹{b.totalAmount?.toLocaleString()}</span>
                      </div>
                    </motion.div>
                  ))}
                </div>
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.35 }} className="card-minimal mt-4">
              <h2 className="text-sm font-semibold text-neutral-600 dark:text-neutral-400 uppercase tracking-wider mb-4">Quick Links</h2>
              <div className="space-y-2">
                {[
                  ...
                  <Link key={link.to} to={link.to}
                    className="flex items-center gap-3 p-2.5 hover:bg-neutral-100 dark:bg-neutral-800 rounded-xl transition-colors group">
                    <div className="w-7 h-7 bg-neutral-100 dark:bg-neutral-800 group-hover:bg-neutral-200 dark:hover:bg-neutral-700 rounded-lg flex items-center justify-center transition-colors">
                      <link.icon className="w-3.5 h-3.5 text-neutral-600 dark:text-neutral-400" />
                    </div>
                    <span className="text-sm text-neutral-700 dark:text-neutral-300 group-hover:text-neutral-900 dark:text-neutral-100 transition-colors">{link.label}</span>
                    <ArrowRight className="w-3.5 h-3.5 text-neutral-600 group-hover:text-neutral-600 dark:text-neutral-400 ml-auto transition-colors" />
                  </Link>
                ))}
              </div>
            </motion.div>
